 $(window).on('load', function() {
  ...
  const btnPrev =  document.getElementById("department-detail-images-prev-btn");
  const btnNext =  document.getElementById("department-detail-images-next-btn");
  const elem = $(".item-image-container-root");
  const subEl = document.getElementById("item-image-department-detail-container");
  const subEl2 = $("#item-image-department-detail-container");
  let childrens = null;
  let initItemSize = 0;
